# Gate 3 Report -- Promotion & Recursive Interaction
...
| C2 compression (median over B,C) | 0.162 | > 0.15 | YES |
...
| B | A | 0.935 | 0.825 | -0.103 |
| B | B | 0.960 | 0.968 | +0.005 |
| B | C | 0.268 | 0.172 | -0.095 |
| C | A | 0.535 | 0.425 | -0.110 |
| C | B | 0.927 | 0.920 | -0.003 |
| C | C | 0.688 | 0.705 | +0.010 |
...
| Acc_A after C (retention) | 0.535 | 0.425 |
| BT_A = Acc_A(after C) - Acc_A(after A) | -0.402 | -0.512 |
...
**Gate 3 does not pass.** Failing: C1 behavioral (worst gap 0.110); C3 lifecycle.

Forward/backward transfer: F and P both retain Phase A above the no-prior floor (P Acc_A after C = 0.425 vs N = 0.135), confirming continual learning is real; promotion tracks flat (F Acc_A after C = 0.535).
